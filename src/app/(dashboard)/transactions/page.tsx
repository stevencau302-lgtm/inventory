      ...
      <div className="rounded-2xl bg-[#1a1a1a] border border-white/[0.06] p-6 lg:p-8">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link href="/transactions/return" className="px-4 py-2 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 text-amber-400 text-sm font-bold transition flex items-center gap-2 active:scale-95">
        ...
        {filteredTx.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="w-16 h-16 rounded-2xl bg-[#FDC800]/10 border border-[#FDC800]/20 flex items-center justify-center mb-4">
              <svg className="w-8 h-8 text-[#FDC800]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-zinc-200 mb-1">Belum ada transaksi</h3>
            <p className="text-sm text-zinc-500 text-center max-w-xs mb-5">Catat barang masuk atau keluar untuk memulai tracking inventory.</p>
            <Link href="/transactions/new" className="px-5 py-2.5 rounded-lg bg-[#FDC800] text-[#000000] text-sm font-bold shadow-lg shadow-[#FDC800]/20 hover:shadow-[#FDC800]/30 hover:bg-[#FDC800]/90 transition-all active:scale-95">
        ...
        <div className="flex items-center justify-between px-1">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={txPage === 1}
              className="px-3 py-1.5 rounded-lg border border-white/[0.08] text-xs font-medium text-zinc-400 hover:bg-[#FDC800] hover:text-black hover:border-[#FDC800] disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-zinc-400 disabled:hover:border-white/[0.08] transition-all"
            >
              Prev
            </button>
            <span className="text-xs text-zinc-500 min-w-[60px] text-center">{txPage} / {totalTxPages}</span>
            <button
