...
function ThemeToggle() {
  return (
    <button className="w-9 h-9 rounded-xl flex items-center justify-center text-zinc-400 hover:text-teal-400 transition"
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
              ...
              <header className="h-14 flex items-center justify-between px-4 md:px-6 shrink-0 border-b border-white/[0.04]"
                ...
                <div className="flex items-center gap-3">
                  <button onClick={() => setSidebarOpen(true)} className="lg:hidden w-9 h-9 rounded-xl flex items-center justify-center text-white hover:text-teal-400 transition"
                    style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="relative w-9 h-9 rounded-xl flex items-center justify-center text-zinc-400 hover:text-white transition"
                    ...
                    <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-teal-500 rounded-full text-[9px] font-bold flex items-center justify-center text-white border-2 border-[#0A0A0F]">3</span>
                  </button>
                  <ThemeToggle />
                </div>
              </header>
