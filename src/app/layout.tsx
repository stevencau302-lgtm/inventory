            ...
            <main className="flex-1 flex flex-col overflow-hidden">
              <header className="h-14 bg-cozy-surface dark:bg-[#111113] border-b border-cozy-border dark:border-[#2a2a2e] flex items-center justify-between px-4 md:px-6 shrink-0">
                <div className="flex items-center gap-3">
                  <button onClick={() => setSidebarOpen(true)} className="lg:hidden w-9 h-9 rounded-xl bg-cozy-gray dark:bg-[#18181b] border border-cozy-border dark:border-[#27272a] flex items-center justify-center text-cozy-text dark:text-[#fafafa]">
