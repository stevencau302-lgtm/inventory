  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f0f1a] px-5 py-6 border border-white/[0.06]">
        ...
        <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="rounded-xl p-4 bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm">
            ...
            <p className="text-2xl font-bold text-[#16A34A]">{totalMasuk}</p>
          ...
          <div className="rounded-xl p-4 bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm">
            ...
            <p className="text-2xl font-bold text-[#DC2626]">{totalKeluar}</p>
          ...
          <div className="rounded-xl p-4 bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm">
            ...
            <p className="text-2xl font-bold text-[#DC2626]">{stokHabis}</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {/* Stok Menipis */}
        <div className="rounded-xl p-5 bg-[#1a1710] border border-amber-500/[0.15]">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-[#FDC800]/15 text-[#FDC800] border border-[#FDC800]/30">Alert</span>
          </div>
          <p className="text-[11px] text-zinc-400 font-medium uppercase tracking-wider">Stok Menipis</p>
          <p className="text-3xl font-bold text-[#FDC800] mt-1">{stokMenipis}</p>
          <p className="text-[11px] text-zinc-500 mt-1">Produk perlu restock</p>
        </div>

        {/* Stok Habis (detail) */}
        <div className="rounded-xl p-5 bg-[#1a1212] border border-red-500/[0.15]">
          <div className="flex items-center justify-between mb-3">
          ...
          <p className="text-[11px] text-zinc-400 font-medium uppercase tracking-wider">Stok Habis</p>
          <p className="text-3xl font-bold text-[#DC2626] mt-1">{stokHabis}</p>
          <p className="text-[11px] text-zinc-500 mt-1">Produk tidak tersedia</p>
        </div>

        {/* Nilai Aset */}
        <div className="rounded-xl p-5 bg-[#14121a] border border-[#432DD7]/[0.2]">
          <div className="flex items-center justify-between mb-3">
          ...
          <p className="text-2xl font-bold text-[#FDC800] mt-1">{formatRp(nilaiAset)}</p>
